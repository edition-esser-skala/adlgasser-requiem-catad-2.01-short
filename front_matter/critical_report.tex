...
\eesCriticalReport{
  – & – & – & According to the catalogue of works by de Catanzaro and Rainer, \B1 contains large cuts compared to the authentic copy in A-Sd (RISM ID 659000014) in most movements: \textit{Requiem} (27 bars in \B1 vs 47 bars in A-Sd), \textit{Te decet} (54 vs 68), \textit{Kyrie} (29 vs 43), \textit{Dies irae} (62 vs 66), \textit{Liber scriptus} (222 vs 254), \textit{Domine Jesu Christe} (85 vs 94), \textit{Quam olim Abrahae 1} (43 vs 136), \textit{Hostias} (38 vs 65), \textit{Quam olim Abrahae 2} (43 vs 41), \textit{Sanctus} (21 vs 25), \textit{Osanna 1} (11 vs 23), \textit{Benedictus} (35 vs 102), \textit{Osanna 2} (11 vs 13), \textit{Agnus Dei} (X vs 43), and \textit{Requiem} (X vs 47). There are no cuts in the \textit{Lacrimosa} (30 bars in both \B1 and A-Sd). Moreover, the ob parts do not appear in A-Sd. \\
